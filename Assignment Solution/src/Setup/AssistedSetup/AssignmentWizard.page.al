page 50104 "RAA Assignment Wizard"
{
    Caption = 'Assignment';
        ...
        area(Content)
        {
            ...
            group(Step1)
            {
                ...
                group("Welcome to Assignment")
                {
                    ...
                    {
                        ShowCaption = false;
                        InstructionalText = 'This is the wizard helping you setup the Assignment Solution';
                    }
                }
                group("Let's go!")
                {
                    ...
                    {
                        ShowCaption = false;
                        InstructionalText = 'In the following pages you will be asked to assign No. Series used in the Assignment Solution';
                    }
                }
            }
            ...
            {
                ShowCaption = false;
                InstructionalText = 'In this step you will decide which No. Series you will use, when creating assignmnets.';
            ...
            group(Step3)
            {
                ...
                {
                    ShowCaption = false;
                    InstructionalText = 'Congratulations you can now start using the Assignment Solution.';
                }
                group("That's it!")
                {
                    Caption = 'That''s it!';
