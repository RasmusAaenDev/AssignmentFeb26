codeunit 50106 "RAA Demo Data Loader" implements "RAA IAssignmentData"
{
    procedure GetData()
    var
        AssignmentMgt: Codeunit "RAA Assignment Mgt.";
    begin
        AssignmentMgt.InsertAssignment('Setup Assignment Solution', 'Remember to setup the assignment solution');
        AssignmentMgt.InsertAssignment('Verify Setup', 'Verify the assignment solution');
        AssignmentMgt.InsertAssignment('Test Solution', 'Test the assignment solution');
